...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE GENERATING SYSTEM, COMPUTER SCIENCE DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/lab1.png" alt="Chania">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Prof.GARDENER</h3>
                    <hr/>
                    <h4 align="center">Dean<br/>F/O Applied Science </h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/princi.png" class="img-rounded"/>
                    <h3 align="center">PROF.ANDREW</h3>
                    <hr/>
                    <h4 align="center">Administrator<br/></h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">DR.ELLIOT</h3>
                    <hr/>
                    <h4 align="center">H.O.D<br/>Computer Science Department</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Find Us Our Socials:,
                </h4>
                <h4><strong>Call:</strong> 0279038909 </h4>
                <h4><strong>Email: </strong>drafael11@hotmail.com</h4>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1"
            ...
            <h2>Social Conectivity</h2>
            <hr/>
            <div>
                <a href="https://facebook.com"> <img src="assets/img/Social/facebook.png" alt=""/> </a>
                <a href="https://google.com"> <img src="assets/img/Social/google-plus.png" alt=""/></a>
                <a href="https://twitter.com"> <img src="assets/img/Social/twitter.png" alt=""/></a>
            </div>
        </div>
