    ...
    <div id="TT" style="background-color: #FFFFFF">
        <table border="2" cellspacing="3" align="center" id="timetable">
            ...
            <tr>
                ...
                <td style="text-align:center">7:00-9:00</td>
                ...
                <td style="text-align:center">17:30-19:00</td>
                ...
                <td style=\"text-align:center\">LUNCH</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE GENERATING SYSTEM, COMPUTER SCIENCE DEPARTMENT, TTU.";
